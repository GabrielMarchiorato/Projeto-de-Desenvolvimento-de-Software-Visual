...
namespace proj_semestre_backend.Services {
    public class MovementService: IMovementService {
        ...
        public void deleteMovement(User user, int movementId) => 
            _movementRepository.deleteMovement(user, movementId);
        public List<Movement> getMovementsForUser(User user) => 
            _movementRepository.getMovementsForUser(user);
        public ValueTask<Movement> insertMovements(User user, Movement movement) => 
            _movementRepository.insertMovements(user, movement);
        public Movement updateMovementInfo(User user, Movement movement) => 
            _movementRepository.updateMovementInfo(user, movement);
    }
}